...
export default function DeleteTrivia({ triviaId }) {
  ...
  return (
    ...
    <div>
      ...
      {/* Modal toggle */}
      <button
        className="absolute top-2 right-2 h-8 w-8 rounded-xl bg-red-500 hover:bg-red-300 text-xl text-white hover:text-red-500 font-bold focus:ring-4 focus:ring-orange-300"
        type="button"
        onClick={toggleModal}
      >
        X
